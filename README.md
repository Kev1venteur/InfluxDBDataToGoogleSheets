...
- [ ] Turn on the Google Drive API from this page : https://developers.google.com/drive/api/v3/quickstart/python </br></br>
- [ ] Just install python 3.8 and execute [The bash script](grafana-data_exporter.sh). </br>
