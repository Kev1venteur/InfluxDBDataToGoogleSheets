...
``` sh
pip install --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --trusted-host pypi.org --upgrade pip --upgrade google-api-python-client google-auth-httplib2 google-auth-oauthlib
```
</br>
